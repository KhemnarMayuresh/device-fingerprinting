/*!
 * device-fingerprint.js v1.0.0 (https://github.com/biggora/device-uuid/)
 */


function DeviceFingerprinting(options) {
    ...
    options = navigator.userAgent ? navigator.userAgent : {};
    var defOptions = {
        version: false,
        language: false,
        platform: true,
    ...
    this.parse = function get(source) {
        ...
        var ua = new DeviceFingerprinting();
    ...
    // generate hash value of browser fingerprinting
    this.getDeviceFingerprint = function (customData) {
    ...
    // generate hash value of device + browser fingerprinting
    this.getBrowserFingerprint = function (customData) {
        var pref = 'a', du = this.parse();
        var dua = [];
    ...
    // randomly generated hash value to sotre in local storage as FCM Token
